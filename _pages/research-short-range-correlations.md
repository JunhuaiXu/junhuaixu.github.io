...
<div class="research-detail research-story">
  ...
  <section class="detail-section">
    ...
    <div class="equation-strip">n + p &rarr; n + p + &gamma;</div>

    <p>
      If the initial nuclei contain SRC-induced high-momentum nucleons, the participating np pairs carry larger
      relative kinetic energies. This hardens the emitted gamma-ray spectrum, especially at the high-energy end.
      Because energetic gamma rays interact only electromagnetically with the nuclear medium, they suffer much
      weaker final-state interactions than hadronic probes and provide a clean window into the early collision
      dynamics.
    </p>
  </section>
