...
\begin{tabularx}{\linewidth}{@{}Xr@{}}
  ...
  {\small\color{muted}Updated August 2026} \\
...
\cvsection{Profile}
Ph.D. candidate in experimental nuclear physics developing
...
\begin{itemize}[leftmargin=1.25em,itemsep=1pt,topsep=2pt]
  \item Within the IBUU-MDI framework, constrained the SRC-induced
    high-momentum-tail fraction in ${}^{124}$Sn within the IBUU-MDI framework to
...
\newpage
\cvsection{Education}
\entry{Tsinghua University}{Aug. 2022 -- Jun. 2027 (Expected)}{Ph.D. Candidate in Physics; specialization in Experimental Nuclear Physics}
